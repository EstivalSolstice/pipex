...
/*   Updated: 2024/11/13 21:35:19 by joltmann         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex.h"

int	init_split_vars(t_split_vars *v, const char *cmd)
{
	v->i = 0;
	v->j = 0;
...
int	add_token_to_args(t_split_vars *v)
{
	int	k;
...
int	process_cmd(t_split_vars *v, const char *cmd)
{
	while (*cmd)
	{
